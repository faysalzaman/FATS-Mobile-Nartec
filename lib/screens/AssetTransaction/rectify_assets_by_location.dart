...
class RectifyAssetsByLocation extends StatefulWidget {
  const RectifyAssetsByLocation({super.key});

  @override
  State<RectifyAssetsByLocation> createState() =>
      _RectifyAssetsByLocationState();
}

class _RectifyAssetsByLocationState extends State<RectifyAssetsByLocation> {
